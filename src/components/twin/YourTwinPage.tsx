...
const YourTwinPage: React.FC = () => {
  ...
  const Simple3DModel: React.FC = () => {
    return (
      <div className="flex items-center justify-center h-full" style={{ maxHeight: '350px' }}>
        <div className="relative">
          {/* Simple 3D-like human figure using CSS */}
          <div 
            className="relative mx-auto"
            style={{
              width: '150px',
              height: '300px',
              background: 'linear-gradient(135deg, #00B58E 0%, #009a7a 100%)',
              borderRadius: '100px 100px 50px 50px',
              position: 'relative',
              boxShadow: '0 20px 40px rgba(0, 181, 142, 0.3)',
            }}
          >
            {/* Head */}
            <div
              ...
              style={{
                ...
                boxShadow: '0 10px 20px rgba(0, 181, 142, 0.3)',
              }}
            />
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 10px 20px rgba(0, 181, 142, 0.2)',
              }}
            />
            <div
              className="absolute"
                ...
                {healthData.temperature && (
                  <div
                    ...
                    style={{
                      ...
                      width: '20px',
                      height: '20px',
                      background: getHealthStatus(healthData.temperature, 'temperature').color,
                      borderRadius: '50%',
                      boxShadow: `0 0 15px ${getHealthStatus(healthData.temperature, 'temperature').color}40`,
                    }}
                  >
            ...
            {healthData?.steps && (
              <div
                ...
                style={{
                  ...
                  borderRadius: '16px',
                  padding: '6px 10px',
                  boxShadow: '0 5px 15px rgba(29, 69, 154, 0.3)',
                }}
              >
